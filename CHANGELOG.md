...
## [0.9.8] - 2026-08-07 - Pre-release

> Major rewrite of Gray Wolf System, introducing the new architecture that will become the foundation for version 1.0.0.
> **The project was entirely rewritten!**

### ✨ Added
- File explorer system with a fresh, modern look
- Upload screen now supports uploading files to the current folder
- Create new folders
- Create new files
- Tools menu for modifying files and folders
- User removal

### 🛠️ Changed
- New login screen with a modern design
- Removed button-based file navigation
- Merged text editing and preview screens
- Improved design for the text view/edit screen
- Revamped upload screen with a fresh, modern design
- Temporarily removed log view
- All scripts rewritten
- The ability to view public or private shared files has been removed; to do this, create a user for sharing data and grant access to everyone.
- Temporarily removed installer.sh

### 🐛 Fixed
- Various issues addressed alongside the modifications

### 🚧 Known Missing Features

The following features are planned before the stable 1.0.0 release:
- Image thumbnails
- Built-in audio player
- Better file information page
- Search system
- File copy / move
- Drag & Drop uploads
- User settings
